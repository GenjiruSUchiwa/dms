...
public class FirestoreApplication {
   ...
   /* @Bean
    ...
    private void writeAndReadDocument() throws ExecutionException, InterruptedException {
        ...
        User tom = new User("Tom", "john", new Date(), Gender.MALE,"https://st.depositphotos.com/1003536/55270/v/450/depositphotos_552703550-stock-illustration-flying-bird-dove-as-a.jpg","accestoken");
    ...
    private void updateDocument() throws ExecutionException, InterruptedException {
        ApiFuture<WriteResult> apiFuture = this.firestore.document("users/tom")
                .set(new User("tom", "john", new Date(), Gender.MALE,"https://st.depositphotos.com/1003536/55270/v/450/depositphotos_552703550-stock-illustration-flying-bird-dove-as-a.jpg","accestoken"));
        WriteResult writeResult = apiFuture.get();
        logger.info("Update time: {}", writeResult.getUpdateTime());
    }
    ...
    private void insertUsers() throws ExecutionException, InterruptedException {
        ...
        futures.add(users.document("tom").set(
                new User("tom", "john", new Date(), Gender.MALE,"https://st.depositphotos.com/1003536/55270/v/450/depositphotos_552703550-stock-illustration-flying-bird-dove-as-a.jpg","accestoken")
        ));
        futures.add(users.document("stella").set(
                new User("stella", "john", new Date(), Gender.MALE,"https://st.depositphotos.com/1003536/55270/v/450/depositphotos_552703550-stock-illustration-flying-bird-dove-as-a.jpg","accestoken")
        ));
        futures.add(users.document("john").set(
                new User("john", "john", new Date(), Gender.MALE,"https://st.depositphotos.com/1003536/55270/v/450/depositphotos_552703550-stock-illustration-flying-bird-dove-as-a.jpg","accesskey")));
        // blocking get
    ...
    private void insertUsersBatch() throws ExecutionException, InterruptedException {
        ...
        batch.set(users.document("john"),
                new User("john", "john", new Date(), Gender.MALE,"https://st.depositphotos.com/1003536/55270/v/450/depositphotos_552703550-stock-illustration-flying-bird-dove-as-a.jpg","accestoken"));
    ...
    private void updateAddresses() throws ExecutionException, InterruptedException {
        ...
        futures.add(users.document("tom")
                ...
                .set(new Address("USA", "Douala ", "Litoral", "Bessengue", Address.Type.BILLING)));
